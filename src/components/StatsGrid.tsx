import { TrendingUp, TrendingDown, Target, BarChart3, Trophy, AlertTriangle, Scale, Zap, ArrowDown } from 'lucide-react';
...
export function StatsGrid({ stats }: StatsGridProps) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
      ...
      <StatCard label="Expectancy" value={`$${stats.expectancy}`} icon={Zap} colorClass={stats.expectancy >= 0 ? 'text-profit' : 'text-loss'} />
